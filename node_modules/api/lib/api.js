...
app.get("/list", function(request, response){	
	pool.getConnection(function(err, connection){
		if(err) throw err;
		connection.query('SELECT candidate, emoji, COUNT(emoji) as count, link FROM emoji_counts GROUP BY candidate, emoji ORDER BY candidate ASC, count DESC, link DESC', function(err, rows){ 
			if(err) throw err; 
			connection.release();
